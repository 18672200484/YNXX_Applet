...
namespace CMCS.CarTransport.Queue.Frms.Sys
{
    partial class FrmMainFrame
    {
        ...
        private void InitializeComponent()
        {
			...
			this.btnOpenNoSampler = new DevComponents.DotNetBar.ButtonItem();
			...
			// btnOpenNoSampler
			// 
			this.btnOpenNoSampler.GlobalItem = false;
			this.btnOpenNoSampler.Name = "btnOpenNoSampler";
			this.btnOpenNoSampler.Text = "不采样设置";
			this.btnOpenNoSampler.Click += new System.EventHandler(this.btnOpenNoSampler_Click);
			// 
			// FrmMainFrame
			// 
		...
		private DevComponents.DotNetBar.ButtonItem btnOpenNoSampler;
	}
}
