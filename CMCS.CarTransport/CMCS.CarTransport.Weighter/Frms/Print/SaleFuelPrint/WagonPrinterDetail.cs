...
namespace CMCS.CarTransport.Queue.Frms.Transport.Print.SaleFuel
{
    /// <summary>
    /// 磅单打印
    /// </summary>
    class SaleFuelWagonPrinterDetail : MetroAppForm
    {
        ...
        public SaleFuelWagonPrinterDetail(PrintDocument printDoc)
        {
