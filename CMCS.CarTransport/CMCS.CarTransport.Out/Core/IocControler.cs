...
namespace CMCS.CarTransport.Out.Core
{
    ...
    public class IocControler
    {
        ...
        public void Gate1Up()
        {
            ...
            commonDAO.SetSignalDataValue(CommonAppConfig.GetInstance().AppIdentifier, "道闸1", "1");
        }
        ...
        public void Gate1Down()
        {
            ...
            commonDAO.SetSignalDataValue(CommonAppConfig.GetInstance().AppIdentifier, "道闸1", "0");
        }
        ...
        public void Gate2Up()
        {
            ...
            commonDAO.SetSignalDataValue(CommonAppConfig.GetInstance().AppIdentifier, "道闸2", "1");
        }
        ...
        public void Gate2Down()
        {
            ...
            commonDAO.SetSignalDataValue(CommonAppConfig.GetInstance().AppIdentifier, "道闸2", "0");
        }
        ...
        public void Gate3Up()
        {
            ...
            commonDAO.SetSignalDataValue(CommonAppConfig.GetInstance().AppIdentifier, "道闸3", "1");
        }
        ...
        public void Gate3Down()
        {
            ...
            commonDAO.SetSignalDataValue(CommonAppConfig.GetInstance().AppIdentifier, "道闸3", "0");
        }
        /// <summary>
        /// 道闸4升杆
        /// </summary>
        public void Gate4Up()
        {
            ...
            commonDAO.SetSignalDataValue(CommonAppConfig.GetInstance().AppIdentifier, "道闸4", "1");
        }
        ...
        public void Gate4Down()
        {
            ...
            commonDAO.SetSignalDataValue(CommonAppConfig.GetInstance().AppIdentifier, "道闸4", "0");
        }
