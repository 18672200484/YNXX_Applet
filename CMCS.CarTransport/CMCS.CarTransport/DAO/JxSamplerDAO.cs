...
namespace CMCS.CarTransport.DAO
{
	...
	public class JxSamplerDAO
	{
		...
		{
			return SelfDber.Entities<View_BuyFuelTransport>("where SamplingTime<:SamplingTime and TareTime<:TareTime and IsUse=1 order by InFactoryTime desc", new { SamplingTime = new DateTime(2000, 1, 1), TareTime = new DateTime(2000, 1, 1) });
		}
