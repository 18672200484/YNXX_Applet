...
节为保留字 0*/
        ...
        */
        ...
        uAreaId = 0xff:删除所有区域
        */
		[DllImport("bx_sdk_dual_server.dll", CharSet = CharSet.Unicode)] public static extern int bxDual_dynamicArea_DelArea_G6_Serial(byte[] pSerialName, byte nBaudRateIndex, byte uAreaId);
        ...
        */
        ...
        uAreaCount-动态区ID数组中的个数；
        */
		[DllImport("bx_sdk_dual_server.dll", CharSet = CharSet.Unicode)] public static extern int bxDual_dynamicArea_DelAreaS_G5_Serial(byte[] pSerialName, byte nBaudRateIndex, byte uAreaCount, byte[] pAreaID);
